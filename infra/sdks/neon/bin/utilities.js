...
async function getPackage() {
    if (_packageRef === undefined) {
        ...
        if (_packageRef === undefined) {
            ...
            params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tpc2xlcmRtL25lb24iLCJ2ZXJzaW9uIjoiMC45LjAifX0="), c => c.charCodeAt(0)));
